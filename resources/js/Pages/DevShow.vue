            ...
            <div class="container mt-5 py-5">
                        ...
                        <div v-if="this.dati.name !== null || this.dati.last !== null || this.dati.address !== null || this.dati.phone_number !== null || this.dati.portfolio_url !==null || this.dati.cv_path !== null" class="d-flex flex-column align-items-center align-items-lg-start gap-5">
                            ...
                            <div class="d-flex flex-column align-items-start gap-3">
                                <div v-if="this.dati.address !== null" class="my_login_button d-flex align-items-center rounded px-3 py-2 gap-3" style="max-width: 350px;">
                                    ...
                                    <p id="copyAddress" class="fs-6 text-secondary m-0 text-truncate">{{this.dati.address}}</p>
                                ...
                                <div v-if="this.dati.phone_number !== null" class="my_login_button d-flex align-items-center rounded px-3 py-2 gap-3" style="max-width: 350px;">
                                    <h5 class="text-light fs-6 w-50"> Phone number:</h5>
                                    <p id="copyPhoneNumber" class="fs-6 text-secondary m-0 text-truncate">{{this.dati.phone_number}}</p>
                            ...
                            <div class="d-flex justify-content-center justify-content-lg-center gap-4 w-100">
                                ...
                                <!-- CV -->
                                <a v-if="this.dati.cv_path !== null" class="btn btn-outline-secondary rounded-pill d-flex align-items-center"
                ...
                <div class="d-flex flex-column align-items-center gap-4">
                    ...
                    <ul class="text-light d-inline-flex gap-4 overflow-auto" style="max-width: 100%; min-height: 100px;">
                        <li v-for="review in this.dati.reviews" class="my_background_secondary text-start card rounded py-3 px-5 shadow"
