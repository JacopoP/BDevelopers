...
export default {
    ...
    data() {
        return {
            voidMessage: "This field has not yet been filled",
            dati: {
            ...
            <div class="container mt-5 py-5">
                ...
                <div class="d-flex flex-column gap-4">
                    ...
                    <div
                        ...
                        <div class="order-2 order-lg-2 text-light" v-if="this.dati.about_me">{{ this.dati.about_me }}</div>
                        <div class="order-2 order-lg-2 text-light font-italic" v-else>{{ voidMessage }}</div>
                    ...
                    <div
                        class="d-flex flex-column gap-3 flex-lg-row gap-lg-0 justify-content-between my_login_button p-3 rounded mt-4">
                        <div class="order-2 order-lg-1 text-light" v-if="this.dati.performances">{{ this.dati.performances
                        }}</div>
                        <div class="order-2 order-lg-1 text-light" v-else>{{ voidMessage }}</div>
